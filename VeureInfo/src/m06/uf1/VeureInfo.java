...
public class VeureInfo {
	...
	public static void main(String[] args) {
	    ...
	    En el cas d'objectes ocults, indicar d'alguna manera en la sortida que es tracta efectivament d'un objecte ocult.
	    S'ha d'indicar quina és l'última data que s'ha modificat l'objecte i, en el cas d'objectes modificats els darrers tres dies, s'ha d'indicar
	    d'alguna manera aquest fet de manera VISIBLE.*/
